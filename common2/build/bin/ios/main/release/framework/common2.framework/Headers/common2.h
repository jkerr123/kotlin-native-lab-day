...
@interface Common2MutableSet<ObjectType> : NSMutableSet<ObjectType>
@end;

__attribute__((objc_runtime_name("KotlinMutableDictionary")))
__attribute__((swift_name("KotlinMutableDictionary")))
@interface Common2MutableDictionary<KeyType, ObjectType> : NSMutableDictionary<KeyType, ObjectType>
@end;
...
@interface Common2Number : NSNumber
...
@interface Common2Byte : Common2Number
...
@interface Common2UByte : Common2Number
...
@interface Common2Short : Common2Number
...
@interface Common2UShort : Common2Number
...
@interface Common2Int : Common2Number
...
@interface Common2UInt : Common2Number
...
@interface Common2Long : Common2Number
...
@interface Common2ULong : Common2Number
...
@interface Common2Float : Common2Number
...
@interface Common2Double : Common2Number
...
@interface Common2Boolean : Common2Number
...
@interface Common2Sample : KotlinBase
...
@interface Common2Platform : KotlinBase
...
@interface Common2SampleKt : KotlinBase
